...
if (!server.includes(marker)) {
  ...
  const route = [
    ...
    '      const branchUrl = "https://api.github.com/repos/" + sourceRepo + "/branches/" + sourceBranch;',
    ...
    '      const packageUrl = "https://raw.githubusercontent.com/" + sourceRepo + "/" + sourceBranch + "/package.json";',
    ...
    '      const dispatchUrl = "https://api.github.com/repos/lucaskerim123/OrbitFS-License-Master-V2/actions/workflows/release-master.yml/dispatches";',
    ...
    '        return json(res, 502, { error: "Unable to start Base release workflow (" + dispatchResponse.status + ")", detail: detail.slice(0, 1000) });',
    '      }',
